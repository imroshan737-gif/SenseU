...
export default function AIChat({ isOpen, onClose, isDemo = false }: AIChatProps) {
  ...
  return (
    <div className="fixed bottom-28 right-8 z-50 w-96 md:w-[440px] animate-scale-in">
      <div className="rounded-2xl overflow-hidden border border-border/50 shadow-2xl shadow-primary/10 backdrop-blur-2xl bg-gradient-to-b from-card/98 via-card/95 to-card/90 flex flex-col max-h-[85vh] h-[700px]">
        {/* Header */}
